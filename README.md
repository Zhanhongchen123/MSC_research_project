...
- `Dataset/` -- the three real event-time streams (`outlook.txt`, `lanl_edge1.txt`, `lanl_edge2.txt`), found there by default by the test scripts
...
- test_lanl_edge1_ks.py    natural edge (data: Dataset/lanl_edge1.txt) Comp683203>Comp186884:443; auto frame search -> 300s template, R=3
